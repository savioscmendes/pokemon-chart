...
head(sort(super_effective_results,decreasing = TRUE), n=33)

head(order(super_effective_results,decreasing = TRUE), n=53)

best_combos <- all_combinations[, head(order(super_effective_results,decreasing = TRUE), n=33)]
